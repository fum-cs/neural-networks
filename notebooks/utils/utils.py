...
def figure8(b, w, bs, ws, all_losses):
    ...
    axs[0].annotate(r'$\frac{\partial MSE}{\partial w} \approx' + '{:.2f}$'.format(manual_grad_w), xy=(-.05, 2.6), c='k', fontsize=17)
    ...
    axs[1].annotate(r'$\frac{\partial MSE}{\partial b} \approx' + '{:.2f}$'.format(manual_grad_b), xy=(.62, 2.6), c='k', fontsize=17)
...
def figure10(b, w, bs, ws, all_losses, manual_grad_b, manual_grad_w, lr):
    ...
    axs[0].annotate(r'$-\eta \frac{\partial MSE}{\partial b} \approx' + '{:.2f}$'.format(-lr * manual_grad_w), xy=(1, 2), c='k', fontsize=17)
    ...
    axs[1].annotate(r'$-\eta \frac{\partial MSE}{\partial w} \approx' + '{:.2f}$'.format(-lr * manual_grad_b), xy=(1, 2), c='k', fontsize=17)
